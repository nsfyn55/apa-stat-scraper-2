...
echo "   Should show: login  verify-session  clear-state  extract-player  extract-team"
echo ""
echo "2. Type: apa-stat-scraper extract-player <TAB>"
echo "   Should show: --userid  --url  --league  --output  --format  --launch-browser  --no-terminal"
echo ""
