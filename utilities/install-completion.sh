...
echo "   Should show: login  verify-session  clear-state  extract-player  extract-team  cache-manage"
echo ""
echo "2. Type: apa-stat-scraper extract-player <TAB>"
echo "   Should show: --userid  --url  --league  --output  --format  --launch-browser  --no-terminal  --no-cache"
echo ""
echo "3. Type: apa-stat-scraper cache-manage <TAB>"
echo "   Should show: stats  clear  cleanup"
echo ""
echo "4. Type: apa-stat-scraper cache-manage clear <TAB>"
echo "   Should show: --all  --specific  --action-type  --identifier  --league  --expand"
echo ""
echo "5. Type: apa-stat-scraper extract-player --format <TAB>"
